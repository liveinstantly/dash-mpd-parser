...
const test1_file = 'tests/data/test1_expected.mpd';
const test2_file = 'tests/data/test2_expected.mpd';
const test3_file = 'tests/data/test3_expected.mpd';
const test4_file = 'tests/data/test4_expected.mpd';
const test5_file = 'tests/data/test5_expected.mpd';
const test6_file = 'tests/data/test6_expected.mpd';
const test7_file = 'tests/data/test7_expected.mpd';
